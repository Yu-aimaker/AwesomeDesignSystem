...
7. For AwesomeDS-facing surfaces, load `design-system/brand/awesomeds-brand.md` and preserve its CMY mark, spectrum signature, registration-label, voice, and motion grammar across media. Third-party products keep their own brand contracts.
