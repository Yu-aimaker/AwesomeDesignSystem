...
const ja: Dictionary = {
  ...
  status: { title: "システムステータス", intro: "コンテンツグラフ、鮮度、網羅性の健全性を確認できます。", graph: "根拠グラフ", references: "リファレンス", rules: "標準ルール", artifacts: "成果物", signals: "隔離中のシグナル", buckets: "鮮度の内訳", latest: "最新の鮮度レポート", noReport: "レポートはまだありません。pnpm check:freshness を実行してください。", issues: "グラフの問題" },
