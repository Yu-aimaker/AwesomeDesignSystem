...
const en = {
  ...
  componentDetail: { breadcrumb: "Components", rules: "Rules", stateMatrix: "State matrix", required: "required", anatomy: "Anatomy", keyboard: "Keyboard contract", screenReader: "Screen-reader contract", contentRules: "Content rules", publicApi: "Public API", prop: "Prop", type: "Type", description: "Description", adaptation: "Adaptation contracts", rtl: "RTL", highContrast: "High contrast", reducedMotion: "Reduced motion", tests: "Verification IDs", live: "Live", copyable: "Copyable example", implementation: "Implementation", importPrefix: "Import", importMiddle: "from", importSuffix: "Consume semantic tokens only." },
  ...
  referenceDetail: { teaches: "What this source teaches", applied: "Where AwesomeDS applied it", caveats: "Caveats & anti-imitation", evidence: "Evidence", verified: "Verified", cadence: "Cadence" },
  ...
  canon: { fallbackNotice: "This canonical document is not translated yet. The English source is shown below.", fallbackLanguage: "English", sourceLabel: "Source file" },
} as const;
...
const ja: Dictionary = {
  ...
  referenceDetail: { teaches: "この情報源から得られる知見", applied: "AwesomeDSへの反映先", caveats: "注意事項と模倣防止", evidence: "証拠レベル", verified: "最終確認", cadence: "確認周期" },
  ...
  workbench: { eyebrow: "実行可能なブランドシステム", title: "ブランド・ワークベンチ", intro: "Duolingoから抽出した再利用可能な知見をブランド非依存で実装。人格を、統制されたアイデンティティ、言語、表現、アセットへ変換し、スキーマと検証で支えます。" },
  canon: { fallbackNotice: "この標準文書は未翻訳です。以下に英語の原文を表示します。", fallbackLanguage: "英語", sourceLabel: "原文ファイル" },
};
